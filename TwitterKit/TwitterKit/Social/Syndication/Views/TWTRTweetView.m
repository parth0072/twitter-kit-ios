...
- (void)setBackgroundColor:(UIColor *)color
{
    ...
    self.attachmentContainer.backgroundColor = color;
...
{
    if ([self.delegate respondsToSelector:@selector(tweetView:didTapURL:)]) {
        [self.delegate tweetView:self didTapTweetHashtagEntity:[TWTRTweetDelegationHelper performDefaultActionForTappingHashtag:hashtagEntity]];
    }
}
...
{
    if ([self.delegate respondsToSelector:@selector(tweetView:didTapURL:)]) {
        [self.delegate tweetView:self didTapTweetCashtagEntity:[TWTRTweetDelegationHelper performDefaultActionForTappingCashtag:cashtagEntity]];
    }
}
...
{
    if ([self.delegate respondsToSelector:@selector(tweetView:didTapURL:)]) {
        [self.delegate tweetView:self didTapTweetUserMentionEntity:[TWTRTweetDelegationHelper performDefaultActionForTappingUserMention:userMentionEntity]];
    }
}
